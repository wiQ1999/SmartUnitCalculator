...
public class DatabaseSeeder
{
    ...
    public void Seed()
    {
        ...
        _modelBuilder.Entity<Calculation>().HasData(
            ...
            new() { Id = 101, BaseUnitId = 20, ResultUnitId = 14, Multiplier = 1_000_000_000m },
            new() { Id = 102, BaseUnitId = 20, ResultUnitId = 15, Multiplier = 125_000_000m },
            new() { Id = 103, BaseUnitId = 20, ResultUnitId = 16, Multiplier = 1_000_000m },
            new() { Id = 104, BaseUnitId = 20, ResultUnitId = 17, Multiplier = 125_000m },
            new() { Id = 105, BaseUnitId = 20, ResultUnitId = 18, Multiplier = 1_000m },
            new() { Id = 106, BaseUnitId = 20, ResultUnitId = 19, Multiplier = 125m },
            new() { Id = 107, BaseUnitId = 20, ResultUnitId = 21, Multiplier = 0.125m },
            new() { Id = 108, BaseUnitId = 20, ResultUnitId = 22, Multiplier = 0.001m },
            new() { Id = 109, BaseUnitId = 20, ResultUnitId = 23, Multiplier = 0.000125m },
            new() { Id = 110, BaseUnitId = 21, ResultUnitId = 14, Multiplier = 8_000_000_000m },
            new() { Id = 111, BaseUnitId = 21, ResultUnitId = 15, Multiplier = 1_000_000_000m },
            new() { Id = 112, BaseUnitId = 21, ResultUnitId = 16, Multiplier = 8_000_000m },
            new() { Id = 113, BaseUnitId = 21, ResultUnitId = 17, Multiplier = 1_000_000m },
            new() { Id = 114, BaseUnitId = 21, ResultUnitId = 18, Multiplier = 8_000m },
            new() { Id = 115, BaseUnitId = 21, ResultUnitId = 19, Multiplier = 1_000m },
            new() { Id = 116, BaseUnitId = 21, ResultUnitId = 20, Multiplier = 8m },
            new() { Id = 117, BaseUnitId = 21, ResultUnitId = 22, Multiplier = 0.008m },
            new() { Id = 118, BaseUnitId = 21, ResultUnitId = 23, Multiplier = 0.001m },
            new() { Id = 119, BaseUnitId = 22, ResultUnitId = 14, Multiplier = 1_000_000_000_000m },
            new() { Id = 120, BaseUnitId = 22, ResultUnitId = 15, Multiplier = 125_000_000_000m },
            new() { Id = 121, BaseUnitId = 22, ResultUnitId = 16, Multiplier = 1_000_0000_000m },
            new() { Id = 122, BaseUnitId = 22, ResultUnitId = 17, Multiplier = 125_000_000m },
            new() { Id = 123, BaseUnitId = 22, ResultUnitId = 18, Multiplier = 1_000_000m },
            new() { Id = 124, BaseUnitId = 22, ResultUnitId = 19, Multiplier = 125_000m },
            new() { Id = 125, BaseUnitId = 22, ResultUnitId = 20, Multiplier = 1_000m },
            new() { Id = 126, BaseUnitId = 22, ResultUnitId = 21, Multiplier = 125m },
            new() { Id = 127, BaseUnitId = 22, ResultUnitId = 23, Multiplier = 0.125m },
            new() { Id = 128, BaseUnitId = 23, ResultUnitId = 14, Multiplier = 8_000_000_000_000m },
            new() { Id = 129, BaseUnitId = 23, ResultUnitId = 15, Multiplier = 1_000_000_000_000m },
            new() { Id = 130, BaseUnitId = 23, ResultUnitId = 16, Multiplier = 8_000_000_000m },
            new() { Id = 131, BaseUnitId = 23, ResultUnitId = 17, Multiplier = 1_000_000_000m },
            new() { Id = 132, BaseUnitId = 23, ResultUnitId = 18, Multiplier = 8_000_000m },
            new() { Id = 133, BaseUnitId = 23, ResultUnitId = 19, Multiplier = 1_000_000m },
            new() { Id = 134, BaseUnitId = 23, ResultUnitId = 20, Multiplier = 8_000m },
            new() { Id = 135, BaseUnitId = 23, ResultUnitId = 21, Multiplier = 1_000m },
            new() { Id = 136, BaseUnitId = 23, ResultUnitId = 22, Multiplier = 8m }
        );
